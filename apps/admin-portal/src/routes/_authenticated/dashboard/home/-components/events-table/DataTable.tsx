            ...
            <div className="flex justify-between w-[100%]">
                ...
                <div className=" gap-2 h-24 py-2 ml-4">
                    ...
                    <div className="flex gap-2 my-6">
                        <p>Free</p>
                        <Switch value={table.getColumn('service_fee')?.getFilterValue() as string}  onClick={(e) => {
                            
                            const value = e.target.value;
                            let filterValue = value.toLowerCase() === "on";
                           
                            return filterValue ? table.getColumn("service_fee")?.setFilterValue(value) : table.getColumn("service_fee")?.setFilterValue([]);
                        }}/>
                        <p>Charge</p>
                    </div> 
                </div>
                ...
                <Table>
                    ...
                    {table.getRowModel().rows?.length ? (
                        ...
                        >
                            ...
                            <TableCell key={cell.id} className="border-b-1 border-b-white">
                                <div className="my-4">
