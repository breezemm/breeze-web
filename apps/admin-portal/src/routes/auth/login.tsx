    ...
    <div className="flex justify-center flex-col items-center h-screen">
      ...
      <div className="flex flex-col w-80 mt-8 items-center">
        <div className="flex flex-col items-center gap-6">
          <h1 className="text-2xl text-[var(--neutral-009)] font-bold">
            Welcome !
          </h1>
          <p className="font-normal text-base text-[var(--neutral-009)]">
            This is breeze’s Admin Dashboard.
          </p>
        </div>
        <Form {...form}>
          <form
            onSubmit={form.handleSubmit(onSubmit)}
            className=" mt-20  w-full flex flex-col  "
          >
            ...
            <Link
              to="/"
              className="underline w-full mt-6 text-center font-semibold text-base tracking-tight"
            >
              Forget Password?
            </Link>
          </form>
