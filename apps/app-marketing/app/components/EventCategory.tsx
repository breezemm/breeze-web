...
const EventCategory = ({eventCategory}: { eventCategory: EventCategoryInterface }) => {
    return (
        <div className="flex flex-col items-center">
            <div
                className="border-neutral-7 mb-2 flex h-[100px] w-[100px] items-center justify-center rounded-full border-[1px]">
