...
const TimeLinePost = (props: {
  ...
  return <div className="flex px-6 py-4 border-b-4  gap-2 md:max-w-[375px]">
    <div className="pt-1"><Image src={ProfileImage} alt="profile"/></div>
    <div className="flex flex-1 flex-col gap-4">
      <div>
        <p className="text-neutral-10 font-semibold">{props.data.user.name}</p>
