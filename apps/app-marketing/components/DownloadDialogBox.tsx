...
const DownloadDialogBox = ({children, className}: { children: React.ReactNode, className?: string }) => {
    return (
        <Dialog>
            ...
            <DialogContent style={{borderRadius: '1rem'}}
                ...
                <div className='flex flex-col items-center gap-2'>
                    ...
                    <p className='text-base'>Get an account for <span className='text-green-7 font-bold'>FREE</span>.
                    </p>
                </div>
